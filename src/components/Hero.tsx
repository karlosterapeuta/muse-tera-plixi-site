  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="avatar-stack">
              {[1, 2, 3, 4, 5].map((i) => (
                <div 
                  key={i} 
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-xs font-bold text-white border-2 border-white/30"
                >
                  {['MT', 'JS', 'AP', 'RC', 'LM'][i - 1]}
                </div>
              ))}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 scroll-indicator animate-fade-in" style={{ animationDelay: '0.8s' }}>
        <span className="text-white/60 text-xs uppercase tracking-widest mb-2">Descubra mais</span>
